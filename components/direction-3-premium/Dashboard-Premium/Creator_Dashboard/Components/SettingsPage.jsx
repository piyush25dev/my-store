    ...
    const fetchProfile = async () => {
      try {
        ...
        const { data: profile, error: profileError } = await supabase
          .from("profiles")
          .select(
            "display_name, avatar_url, phone_number, country, bio, business_name",
          )
          .eq("id", user.id)
          .single();
              ...
              <div className="shrink-0">
                {avatarPreview ? (
                  <Image
                    ...
                    width={80}
                    height={80}
                    className="rounded-2xl object-cover shadow-md border-2 border-blue-200"
                  />
              ...
              <div className="flex-1 space-y-3">
                ...
                {avatarFile && (
                  <div className="flex items-center gap-2 px-3 py-2 bg-blue-50 rounded-lg w-fit">
                    <p className="text-xs font-medium text-blue-800 max-w-[180px] truncate">
                      {avatarFile.name}
                    </p>
                    <button
                      onClick={() => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                value={email}
                readOnly
                className="text-sm border-slate-200 bg-slate-50 text-slate-400"
              />
            </div>
            <div className="space-y-1.5">
        ...
        <CardContent className="pt-5 space-y-4">
          ...
          <div className="space-y-3 pt-1">
            {[
              {
                key: "taxEnabled",
                label: "Include GST in prices",
                desc: "18% GST auto-applied at checkout",
              },
              {
                key: "instantDelivery",
                label: "Instant digital delivery",
                desc: "Files delivered immediately after payment",
              },
              {
                key: "allowReviews",
                label: "Allow customer reviews",
                desc: "Buyers can leave ratings and reviews",
              },
              {
                key: "deliveryPartner",
                label: "Use delivery partner",
                desc: "Enable third-party shipping integration",
              },
            ].map(({ key, label, desc }) => (
              <div
                key={key}
              ...
              >
                ...
                >
                  <div
                    className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow transition-all ${store[key] ? "left-5" : "left-1"}`}
                  />
                </button>
              </div>
            ))}
          ...
          {[
            {
              ...
              desc: "Get notified when a purchase is made",
            },
            {
              key: "reviewAlerts",
            ...
            },
            {
              ...
              desc: "When a refund or dispute is raised",
            },
            {
              key: "weeklyReport",
              label: "Weekly summary report",
              desc: "Emailed every Monday morning",
            },
            {
              key: "marketingEmails",
              label: "Marketing tips",
              desc: "Product growth advice from Premium",
            },
          ].map(({ key, label, desc }) => (
            <div
              key={key}
            ...
            >
              ...
              >
                <div
                  className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow transition-all ${notifs[key] ? "left-5" : "left-1"}`}
                />
              </button>
            </div>
          ))}
        ...
        <CardContent className="pt-5 space-y-4">
            ...
            {[
              {
                ...
                value: `₹${creatorSettings.payout.pending.toLocaleString()}`,
                badge: "Next: Jan 20",
              },
              {
                label: "Total Paid Out",
                value: `₹${creatorSettings.payout.totalPaid.toLocaleString()}`,
                badge: null,
              },
              {
                label: "Payment Method",
                value: creatorSettings.payout.method,
                badge: null,
              },
              ...
              >
                ...
                {badge && (
                  <Badge className="mt-1 bg-emerald-100 text-emerald-700 border-0 text-[10px]">
                    {badge}
                  </Badge>
                )}
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
            <div className="space-y-1.5">
              ...
              <Input
                value={creatorSettings.payout.account}
                readOnly
                className="text-sm border-slate-200 bg-slate-50 font-mono"
              />
            </div>
            <div className="space-y-1.5">
              <Label className="text-xs text-slate-500">IFSC Code</Label>
              <Input
                value={creatorSettings.payout.ifsc}
                readOnly
                className="text-sm border-slate-200 bg-slate-50 font-mono"
              />
            </div>
          ...
          <Button
            variant="outline"
            className="text-xs rounded-full border-slate-200 text-slate-600"
          >
            Update Bank Details
          </Button>
        </CardContent>
